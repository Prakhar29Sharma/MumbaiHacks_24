...
export default function Feature() {
    return (
        <>
            <div className="max-w-6xl mx-auto font-[sans-serif] mt-10 mb-10">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
                    ...
                    <h3 className="text-gray-800 text-xl font-semibold mb-3">Personalization</h3>
                    <p className="text-gray-600 text-sm">Personalized learning experience</p>
                    </div>
                    ...
                    <h3 className="text-gray-800 text-xl font-semibold mb-3">Generative AI</h3>
                    <p className="text-gray-600 text-sm">Make use of cutting edge AI tools to enhance learning and content creation</p>
                    </div>
                    ...
                    <h3 className="text-gray-800 text-xl font-semibold mb-3">Community</h3>
                    <p className="text-gray-600 text-sm">Learn and grow with interactive community</p>
                    </div>
                    ...
                    <h3 className="text-gray-800 text-xl font-semibold mb-3">Quality Control</h3>
                    <p className="text-gray-600 text-sm">Get the best course content</p>
                    </div>
                    ...
                    <h3 className="text-gray-800 text-xl font-semibold mb-3">Multilingual Support</h3>
                    <p className="text-gray-600 text-sm">Understand concepts in your language</p>
                    </div>
                </div>
            </div>
        </>
